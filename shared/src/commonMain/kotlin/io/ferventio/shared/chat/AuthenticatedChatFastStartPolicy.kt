 ...
 * channel IDs are already available while channel metadata is still refreshing.
 * Authenticated chat can safely start from this snapshot instead of waiting for that refresh.
 */
 ...
 */
class AuthenticatedChatFastStartAttemptTracker {
